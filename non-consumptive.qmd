...
[^comptext]: Like the keynote roundtable at Comptext 2023 or the *The Post-API Conference* Annenberg Public Policy Center in 2023.
...
there are privacy and other ethical concerns.

Specifically, we present four avenues to share data sets, structured by what is legally and morally justifiable in light of the interests of data owners.
...
![Example text preview including dfm](media/dfm.png){#fig-dfm}
